...
<head>
    ...
    <title>Desa Warungdowo - Galeri</title>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    @foreach ($galeri as $index => $gal)
                        <div class="swiper-slide{{ $index === 0 ? ' active' : '' }}">
                            <a class="gallery-lightbox" href="{{ asset('image/' . $gal->image) }}">
                                <img src="{{ asset('image/' . $gal->image) }}" class="img-fluid" alt="">
                            </a>
                        </div>
                    @endforeach
                </div>
