...
<head>
    ...
    <link href="{{ asset('assets/img/logo_kiri.png') }}" rel="icon">
    <link href="{{ asset('assets/img/logo_kiri.png') }}" rel="apple-touch-icon">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('assets/img/logo_kiri.png') }}" alt="Not Found"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Warungdowo</span>
            </a>
