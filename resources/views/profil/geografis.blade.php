...
<head>
    ...
    <title>Desa Warungdowo - Letak Geografis</title>
                        ...
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="member-info">
                                ...
                                <span style="text-align: left;">
                                    Secara geografis embaga Kemasyarakatan Desa (LKD) Warungdowo termasuk wilayah
                                    Kecamatan Pohjentrek Kabupaten Pasuruan dan termasuk satu dari 9 Desa di Kecamatan
                                    Pohjentrek dengan batas wilayah sebagai berikut :
                                    <br>
                                    • Sebelah Utara : Desa Pleret Kecamatan Pohjentrek
                                    <br>
                                    • Sebelah Timur : Desa Patebon Kec. Kejayan & Desa Gondang Rejo Kec. Gondang Wetan
                                    <br>
                                    • Sebelah Selatan : Desa Sladi Kec. Kejayan & Kel. Kejayan
                                    <br>
                                    • Sebelah Barat : Desa Susukanrejo Kecamatan Pohjentrek
                                    <br>
                                    <br>
                                    Jarak ibu kota Desa ke :
                                    <br>
                                    • Kecamatan : 0,5 km
                                    <br>
                                    • Kabupaten : 10 km
