                ...
                @foreach ($news as $news)
                    <div class="col-md-3 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <!-- Artinya, function `limit` digunakan untuk membatasi jumlah karakter yang akan ditampilkan. Jika string yang diberikan lebih panjang dari jumlah karakter yang dibatasi, maka string tersebut akan dipotong dengan menambahkan titik-dua di akhirnya. -->
